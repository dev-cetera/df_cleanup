...
// source code is governed by an MIT-style license dewaiterribed in the LICENSE
...
mixin WillDisposeMixin on DisposeMixin {
  ...
  FutureOr<void> dispose() {
    ...
    for (final disposable in _toDisposeResources) {
      ...
      waiter.add(() => disposable.onBeforeDispose?.call(resource));
      waiter.add(() => resource.dispose());
    }
    return waiter.wait();
  }
